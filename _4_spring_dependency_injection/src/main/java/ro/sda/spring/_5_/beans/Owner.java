package ro.sda.spring._5.beans;
...
public class Owner {
    ...
    // @Autowired
    private ro.sda.spring._5.beans.Dog dog;
    public Owner() {
        System.out.println("Owner constructor called");
    }
    // setter based injection
    @Autowired
    public void setDog(ro.sda.spring._5.beans.Dog dog) {
    ...
    public ro.sda.spring._5.beans.Dog getDog() {
        return dog;
    }
}